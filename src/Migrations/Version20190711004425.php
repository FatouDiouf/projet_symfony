 ...
 */
final class Version20190711004425 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE employer (id INT AUTO_INCREMENT NOT NULL, services_id INT NOT NULL, matricule VARCHAR(255) NOT NULL, nom VARCHAR(255) NOT NULL, datenaiss DATETIME NOT NULL, salaire INT NOT NULL, INDEX IDX_DE4CF066AEF5A6C1 (services_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
